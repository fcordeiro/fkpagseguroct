    ...
    <div class="fkpagseguroct-panel">
        <form id="fkpagseguroct_form_boleto" action="{$link->getModuleLink('fkpagseguroct', 'validation', [], true)|escape:'html':'UTF-8'}" method="post">
            ...
            <div class="form-group">
                ...
                <input class="form-control fkpagseguroct-col-lg-30" type="tel" placeholder="(00)0000-00000" onkeyup="maskIt(this,event,'(##) ####-#####');" maxlength="15" name="fkpagseguroct_boleto_tel" id="fkpagseguroct_boleto_tel" autocomplete="off" value="">
            </div>

            <div class="fkpagseguroct-sub-panel fkpagseguroct-col-lg-50">

                <div class="fkpagseguroct-panel-heading">
                    {l s="Digite o seu CPF" mod="fkpagseguroct"}
                </div>

                <div class="fkpagseguroct-radio-cpfcnpj" style="display: none;">
                ...
                <div class="form-group">
                    <input class="form-control fkpagseguroct-col-lg-50" type="tel" onkeyup="maskIt(this, event, '###.###.###-##');" maxlength="14" name="fkpagseguroct_boleto_cpf" id="fkpagseguroct_boleto_cpf" autocomplete="off" value="{if isset($cpf)}{$cpf}{/if}" {if !$cnpj}style="display: block; width: 100px;"{else}style="display: none;"{/if}>
                </div>

                <div class="form-group" style="display: none;">
                    <input class="form-control fkpagseguroct-col-lg-50" type="tel" onkeyup="maskIt(this, event, '##.###.###/####-##');" maxlength="18" name="fkpagseguroct_boleto_cnpj" id="fkpagseguroct_boleto_cnpj" autocomplete="off" value="{if isset($cnpj)}{$cnpj}{/if}" {if $cnpj}style="display: block;"{else}style="display: none;"{/if}>
                </div>
            </div>
