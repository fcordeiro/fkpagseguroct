    ...
    <div class="fkpagseguroct">
        ...
        <div class="panel" style="border-top-left-radius: 0">
            ...
            <div class="panel fkpagseguroct-margin-panel fkpagseguroct-col-lg-70">
                ...
                <div class="panel-heading">
                    {l s="Registro da Licença" mod="fkpagseguroct"}
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="fkpagseguroct-col-lg-25 fkpagseguroct-float-left">
                        <input type="text" name="fkpagseguroct_referencia" id="fkpagseguroct_referencia" value="{$tab_1['fkpagseguroct_referencia']}">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="fkpagseguroct-col-lg-25 fkpagseguroct-float-left">
                        <input type="text" name="fkpagseguroct_proprietario" id="fkpagseguroct_proprietario" value="{$tab_1['fkpagseguroct_proprietario']}">
                    </div>
                </div>
