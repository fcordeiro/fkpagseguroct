...
class FKpagseguroctPaymentModuleFrontController extends ModuleFrontController {
    ...
    public function setMedia() {
    	...
    	// MaskedInput não funciona corretamente com dispositivos móveis
        // Máscaras puramente em javascript são mais simples e compatíveis
        // $this->addJS(_PS_MODULE_DIR_.'fkpagseguroct/js/jquery.maskedinput.js');
        
        $this->addJS(_PS_MODULE_DIR_.'fkpagseguroct/js/mask.js');
