...
class FKpagseguroct extends PaymentModule {
    ...
    private $_erroWs = '';
    private $_idProduto = '89';

    public function __construct() {

        $this->name = 'fkpagseguroct';
        $this->tab = 'payments_gateways';
        $this->version = '161.5.1';
        $this->author = 'FokusFirst | Fernando Cordeiro';
    ...
    public function install() {
        ...
        if (!parent::install()
            ...
            Or !Configuration::updateValue('FKPAGSEGUROCT_REFERENCIA', 'Registro liberado')
            Or !Configuration::updateValue('FKPAGSEGUROCT_DOMINIO', '')
            Or !Configuration::updateValue('FKPAGSEGUROCT_PROPRIETARIO', 'Registro liberado')
            ...
            Or !Configuration::updateValue('FKPAGSEGUROCT_ESTOQUE_ZERO', 'on')
    ...
    public function renderForm() {
        ...
        if (Configuration::get('FKPAGSEGUROCT_REFERENCIA') != '' and Configuration::get('FKPAGSEGUROCT_DOMINIO') != '' and Configuration::get('FKPAGSEGUROCT_PROPRIETARIO') != '') {

            if (!$this->wsVerificaLicenca(Configuration::get('FKPAGSEGUROCT_REFERENCIA'), Tools::getShopDomain(false, true))) {
    ...
    private function incRegistro() {
        ...
        // TPL a ser utilizado
        $name_tpl ='incRegistro.tpl';

        $this->smarty->assign(array(
            'tab_1' => array(
                'nameTpl'                       => $name_tpl,
                'formAction'                    => Tools::htmlentitiesUTF8($_SERVER['REQUEST_URI']),
                'fkpagseguroct_referencia'      => Tools::getValue('fkpagseguroct_referencia', Configuration::get('FKPAGSEGUROCT_REFERENCIA')),
                'fkpagseguroct_dominio'         => Tools::getValue('fkpagseguroct_dominio', Trim(Tools::getShopDomain(false,true))),
                'fkpagseguroct_proprietario'    => Tools::getValue('fkpagseguroct_proprietario', Configuration::get('FKPAGSEGUROCT_PROPRIETARIO')),
            )
    ...
    private function postValidation() {
        ...
        switch($sessao) {
            ...
            case 'incRegistro':
                ...
                // Recupera valores
                $referencia = Trim(Tools::getValue('fkpagseguroct_referencia'));
                $dominio = Trim(Tools::getShopDomain(false, true));
                $proprietario = Trim(Tools::getValue('fkpagseguroct_proprietario'));
            ...
            case 'altRegistro':
                ...
                if (!$this->wsAlteraLicenca(Configuration::get('FKPAGSEGUROCT_REFERENCIA'), Tools::getShopDomain(false,true))) {
                    $this->_postErrors[] = $this->_erroWs;
                }
    ...
    private function postProcess($sessao) {
        ...
        switch($sessao) {
            ...
            case 'incRegistro':
                ...
                Configuration::updateValue('FKPAGSEGUROCT_REFERENCIA', Trim(Tools::getValue('fkpagseguroct_referencia')));
                Configuration::updateValue('FKPAGSEGUROCT_DOMINIO', Trim(Tools::getShopDomain(false,true)));
                Configuration::updateValue('FKPAGSEGUROCT_PROPRIETARIO', Trim(Tools::getValue('fkpagseguroct_proprietario')));
            ...
            case 'altRegistro':
                ...
                Configuration::updateValue('FKPAGSEGUROCT_REFERENCIA', '');
                Configuration::updateValue('FKPAGSEGUROCT_DOMINIO', '');
                Configuration::updateValue('FKPAGSEGUROCT_PROPRIETARIO', '');
            ...
            case 'configGeral':
                ...
                Configuration::updateValue('FKPAGSEGUROCT_ESTOQUE_ZERO', Tools::getValue('fkpagseguroct_estoque_zero'));
